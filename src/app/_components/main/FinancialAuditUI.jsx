...
export default function FinancialAuditUI() {
  ...
  return (
    <div className="lg:min-h-screen text-center flex flex-col items-center lg:mb-60 max-sm:px-12 md:pb-32">
      ...
      {/* Dashboard Preview */}
      <div className="w-full relative max-sm:-mt-8 flex items-center justify-center bg-gradient-to-b from-white via-gray-200 to-white">
        <motion.div
          initial={{ scale: 0.6 }}
          animate={{ scale: 1 }}
        ...
        >
          <div className="mx-auto max-md:w-screen relative">
            ...
            <div className="bg-slate-50 max-md:w-full py-6 w-[78%] text-center md:absolute -bottom-80 left-28 md:rounded-2xl  outline outline-2 outline-white md:outline-offset-8 md:shadow-lightBlack">
              ...
              <div
                ref={containerRef}
                className="flex md:flex-wrap overflow-auto scrollbar-hide py-2 gap-4 mt-2 cursor-pointer md:justify-center xs:mx-2"
              >
                {navigationOptions.map((option, index) => (
                  <div
                    ...
                    className="px-4 py-3 bg-white md:shadow-lightorange rounded-xl flex flex-col items-center justify-center gap-2.5 min-w-[7rem] w-[7rem] "
                  >
                    <span
