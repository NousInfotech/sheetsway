...
export default function ChangingText({
  ...
  return (
    <div className="text-gray-800 text-center px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12">
      ...
      <p
        className={`text-gray-800 text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-medium font-nunito leading-none ${className}`}
      >
        {paraTextStart}{" "}
